<?php
class KwcIntegratorTemplate_Kwc_Advanced_IntegratorTemplateLegacy_Trl_Form extends Kwc_Abstract_Form
{
    protected function _init()
    {
        ...
        $this->add(new Kwf_Form_Field_ShowField('template_url', trl('HTML Template URL')))
            ->setWidth(500)
            ->setData(new KwcIntegratorTemplate_Kwc_Advanced_IntegratorTemplateLegacy_Trl_FormData());
    }
}

class KwcIntegratorTemplate_Kwc_Advanced_IntegratorTemplateLegacy_Trl_FormData extends Kwf_Data_Abstract
{
